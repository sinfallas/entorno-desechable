...
- **Configuración centralizada:** Toda la parametrización (hardware, red, plantillas y tokens) se lee directamente desde un archivo `.env`[cite: 1, 2].
...
- Acceso SSH al host de Proxmox con privilegios de **root** (el script requiere ejecución como superusuario)[cite: 1].
